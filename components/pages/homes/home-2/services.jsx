...
const ServicesTwo = () => {
    const slideControl = {
        spaceBetween: 35, // increased from 25 to 35 for more horizontal space
        slidesPerView: 4,
        speed: 1000,
        loop: true,
        autoplay: {
                ...
                <div className="row al-end">
                    <div className="col-lg-12">
                        <div className="services__two-title t-center">
                            ...
                            <h2 className="wow fadeInRight" data-wow-delay=".6s">We Provide Quality Services</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <SwiperSlide key={id}>
                                    <div
                                        ...
                                        style={{
                                            ...
                                            marginBottom: "16px" // add vertical space between items
                                        }}
                                    >
                                        {data.icon}
